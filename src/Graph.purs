...
import Prelude
import Data.Array ((!!), deleteAt, elem, filter, mapMaybe, snoc, updateAtIndices)
...
type Graph = { layout ∷ Array Position, edges ∷ Array Edge }
...
removeVertex i graph = graph {  layout = fromMaybe graph.layout $ graph.layout # deleteAt i
